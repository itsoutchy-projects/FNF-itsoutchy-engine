...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuItem:FlxSprite = new FlxSprite(100, 30);
		...
		var menuItem:FlxSprite = new FlxSprite(100, 130);
		...
		var menuItem:FlxSprite = new FlxSprite(100, 230);
		...
		var menuItem:FlxSprite = new FlxSprite(100, 330);
		...
		var menuItem:FlxSprite = new FlxSprite(100, 430);
		...
		var menuItem:FlxSprite = new FlxSprite(100, 530);
		...
		var menuItem:FlxSprite = new FlxSprite(100, 630);
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "itsoutchy Engine v0.1", 12);
